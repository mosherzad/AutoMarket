...
-- CreateEnum
CREATE TYPE "CarType" AS ENUM ('SEDAN', 'SUV', 'HATCHBACK', 'COUPE', 'PICKUP', 'VAN');

-- CreateEnum
CREATE TYPE "Location" AS ENUM ('ERBIL', 'DUHOK', 'SULAYMANIAH', 'KIRKUK', 'MOSUL', 'BAGHDAD', 'BASRA', 'NAJAF', 'ANBAR', 'SALAHALDIN', 'OTHER');
